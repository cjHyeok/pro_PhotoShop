                    ...
                    <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-custom">
                        <div class="login-register-wrapper">
                            ...
                            <form action="productAdd" method="post">
                                ...
                                <div class="single-input-item mb-3">
                                    <textarea rows="3" cols="48" id="product_description_summary" name="product_description_summary" type="text" placeholder="상품 설명"></textarea>
                                
                                </div>                              
                                
                                <div class="single-input-item mb-3">
                                    <textarea rows="4" cols="48" id="product_description" name="product_description" type="text" placeholder="상품 상세 설명"></textarea>
                                </div>
